...
每条边的流量要求有个上下界，并且每个点都要满足流量平衡。

建立附加源点ss，附加汇点tt。 

初始假设每条边都已经有了下界的流量，这样可能会使得流量不平衡。

建立残余网络

设 a[i] 表示i点流入的流量与流出的流量之差。
...
跑ss到tt的最大流，如果从ss出去的边全部满流，则证明有解，否则无解。
...
建立(t,s) 容量为无穷大的边，再跑无源汇可行流即可。

## 有源汇上下界最大流

做完有源汇可行流后，再跑一次s到t的最大流即可。

## 有源汇上下界最小流

做完有源汇可行流后，跑一次t到s的最大流。（？）